...
export const TextRevealCard = ({
    ...
    return (
        <div
            ...
            ref={cardRef}
            className={cn(
                "bg-[#1d1c20] border border-white/[0.08] w-[35rem] rounded-lg p-8 relative overflow-hidden",
                className
            )}
        >
            {children}
            ...
            <div className="h-40  relative flex items-center overflow-hidden">
                <motion.div
                    ...
                    className="absolute bg-white dark:bg-black-100 z-20  will-change-transform"
                >
                    <p
                        style={{
